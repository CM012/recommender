...
parser.add_argument('-m', type=float, nargs='+', help='List of the margin') #margin
...
m.Equation(sweetpotato_nu[0]*sweetpotato + redlentils_nu[0]*redlentils + avocado_nu[0]*avocado <= carb + margin[2])
m.Equation(sweetpotato_nu[0]*sweetpotato + redlentils_nu[0]*redlentils + avocado_nu[0]*avocado >= carb - margin[2]) 
m.Equation(sweetpotato_nu[1]*sweetpotato + redlentils_nu[1]*redlentils + avocado_nu[1]*avocado <= protein + margin[2])
m.Equation(sweetpotato_nu[1]*sweetpotato + redlentils_nu[1]*redlentils + avocado_nu[1]*avocado >= protein - margin[2])
m.Equation(sweetpotato_nu[2]*sweetpotato + redlentils_nu[2]*redlentils + avocado_nu[2]*avocado <= fat + margin[2])
m.Equation(sweetpotato_nu[2]*sweetpotato + redlentils_nu[2]*redlentils + avocado_nu[2]*avocado >= fat - margin[2])
